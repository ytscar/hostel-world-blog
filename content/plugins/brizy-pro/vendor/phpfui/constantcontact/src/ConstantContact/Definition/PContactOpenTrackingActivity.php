 ...
 * @property string $device_type The type of device that was used to open the link.
 ...
 */
class PContactOpenTrackingActivity extends \PHPFUI\ConstantContact\Definition\Base
	{
