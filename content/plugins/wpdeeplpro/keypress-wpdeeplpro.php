...
class KeyPressWPDeepLPro extends KeyPressAPIClient {
	...
	const OPTIONKEY_RENEWAL_LINK = 'keypress_wpdeeplpro_renewal_link';
	const OPTIONKEY_RENEWAL_MESSAGE = 'keypress_wpdeeplpro_renewal_message';
	const OPTIONKEY_RENEWAL_REMINDER = 'keypress_wpdeeplpro_renewal_reminder';
